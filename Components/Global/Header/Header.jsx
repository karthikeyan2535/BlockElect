...
const Header = () => {
  ...
  const bgColor = "bg-custom";
  const txtColor = "text-custom-dark";
  return (
    <header class="header-section a2-bg-0 header-section--secondary header-menu w-100">
      <div class="container d-center">
        <nav className={` navbar ${theme==='dark'?"bg-dark":bgColor} a2-lg-bg py-5 p-lg-5 rounded-3 navbar-expand-lg w-100 justify-content-between`}>
          <div class="d-flex align-items-center">
            ...
            >
              ...
              <img
                ...
                class="logo d-none d-sm-flex ml-8"
                alt="logo"
                width={150}
              />
            </a>
          ...
          <div class="nav_alt">
            <div class="right-area position-relative ms-0 d-center gap-4 gap-xl-6 d-lg-none">
              {address ? (
                <>
          ...
          >
            <ul class="navbar-nav gap-2 gap-lg-3 gap-xxl-8  align-self-center mx-auto mt-4 mt-lg-0">
              <li class={`dropdown show-dropdown ${theme==='dark'?"":"text-dark"}`}>
                <a href="/" class={`dropdown-nav active ${theme==='dark'?"":txtColor}`}>
                  home
                </a>
              </li>
              <li class="dropdown show-dropdown">
                <button
                  ...
                  class={`dropdown-nav ${theme==='dark'?"":"text-dark"}`}
              ...
              {address == OWNER_ADDRESS?.toLowerCase() && (
                <li className={`${theme==='dark'?"":"text-dark"}`}>
          ...
          <div class="right-area position-relative  ms-0 d-center gap-1 gap-xl-4 d-none d-lg-flex">
            {address ? (
              <>
                <div class="single-item">
                  <a
                    href="/voter"
                    class={`rotate_eff flex-nowrap py-1 px-2 px-xl-3 d-center gap-1 fw-bold nw1-color ${theme==='dark'?"":"text-dark"}`}
                  >
                    {" "}
                    Voter <i class="ti ti-arrow-right fs-six-up"></i>
                  </a>
            ...
            <div
              className={`toggler--slider ${theme==='dark' ? '' : 'light'}`}
              onClick={() => (toggleTheme())}
            >
              {console.log(theme)}
